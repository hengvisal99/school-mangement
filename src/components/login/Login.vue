    ...
    <div class="flex flex-col basis-6/12 justify-center items-center">
      <div class="border rounded-2xl p-8 shadow-lg width-5">
        ...
        <!-- <div class="flex flex-row gap-5 mb-3 justify-center">
          <button class="border rounded-lg h-10 w-40 text-center p-2">
        ...
        <div class="flex flex-col gap-2">
          ...
          />
          <small id="username-help" class="mb-2"
        ...
        <div class="flex flex-col gap-2">
          ...
          <Password
            ...
            :feedback="false"
          />
          <small id="password-help" class="mb-2">Enter your password.</small>
        </div>
        ...
        <div class="flex flex-col gap-4">
          <Button class="w-full mt-4" label="Login" severity="info" raised />
        </div>
        ...
        <div class="flex flex-row gap-5 mb-3 justify-center">
          <button class="border rounded-lg h-10 w-40 text-center p-2 hover:bg-slate-200">
