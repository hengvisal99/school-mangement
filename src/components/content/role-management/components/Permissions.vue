            ...
            <template #default>
                <BaseDataTable v-if="!isLoading" :tableData="roles" :columns="tableColumns"
                    ...
                    <template #headerButton>
                        <Button label="Add Permission" @click="showRoles" class="flex-initial w-44 active:bg-primary-700 
...
const rolesList = defineAsyncComponent(() => import('@/components/content/role-management/dialog/PermissionDialog.vue'));
